...
public:
    CTestNetParams() {
        ...
        consensus.BIP65Height = 88;
        consensus.BIP66Height = 98;
        ...
        consensus.nPowDGWHeight = 42; // TODO: make sure to drop all spork6 related code on next testnet reset
